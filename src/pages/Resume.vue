<template>
  <Layout class="md:bg-gray-100 print:bg-white">
    <div
      class="resume print:p-0 print:border-0 bg-white md:p-8 md:pl-12 md:border md:border-gray-600 resume-wrapper narrow-container mx-auto text-gray-900 leading-tight mt-8 print:mt-0"
    >
      ...
      <resume-section class="education-area">
        ...
        >
          <div class="font-semibold text-gray-700 mb-1">
            ...
            <h5
              class="text-sm font-semibold whitespace-no-wrap"
      ...
      <resume-section class="skills-area mb-3">
        ...
        <div
          ...
          :key="skill.header"
          class="mb-6 no-break-inside"
        >
          <h4
            class="text-xs font-semibold tracking-wider uppercase text-gray-800 mb-1"
            v-text="skill.header"
          ></h4>
          <ul class="text-sm flex flex-wrap -m-1">
            <li
              v-for="name in skill.list"
              :key="name"
              v-text="name"
      ...
      <resume-section class="projects-area" v-if="displayProjects.length > 0">
        <template slot="header"
          >Projects</template
        >
        <div
    ...
    <button
      @click="print"
      class="fixed bottom-0 right-0 mb-6 mr-6 bg-teal-500 text-white w-12 h-12 rounded-full flex items-center justify-center shadow-md print:hidden"
    >
      <feather-icon
        name="printer"
        class="w-4 h-4"
